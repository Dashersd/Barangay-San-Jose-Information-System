...
<head>
    ...
    <title>Manage Media Gallery - Admin Panel</title>
        ...
        <main class="admin-main">
            ...
            <div class="admin-content">
                <div class="content-header d-flex justify-content-between align-items-center" style="margin-bottom: 1.5rem;">
                    <h2 style="margin: 0; font-size: 1.25rem; font-weight: 700; color: var(--text, #1C1917);">Media Library</h2>
                    <label class="btn btn-primary" style="display: flex; align-items: center; gap: 0.5rem; border: none; cursor: pointer; padding: 0.6rem 1.2rem; border-radius: 6px; font-weight: 600; margin: 0;">
                        + Upload Media
                    ...
                    <div class="gallery-grid">
                        ...
                        <div class="media-card">
                            ...
                            <div class="media-info">
                                <span>Barangay Hall Facade</span>
                            </div>
                        </div>
                        <!-- Media Card 2 -->
                        <div class="media-card">
                            <div class="media-placeholder"></div>
                            <div class="media-info">
                                <span>Medical Mission 2026</span>
                            </div>
                        </div>
                        <!-- Media Card 3 -->
                        <div class="media-card">
                            <div class="media-placeholder"></div>
                            <div class="media-info">
                                <span>Coastal Clean-up Drive</span>
                            </div>
                        </div>
                        <!-- Media Card 4 -->
                        <div class="media-card">
