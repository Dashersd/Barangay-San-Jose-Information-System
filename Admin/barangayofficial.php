...
<head>
    ...
    <title>Manage Barangay Officials - Admin Panel</title>
    ...
    <link rel="stylesheet" href="css/barangayofficial.css">
</head>
<body>
            ...
            <ul class="sidebar-nav">
                ...
                <li class="admin-dropdown">
                    ...
                    <ul class="admin-dropdown-menu show">
                        <li><a href="barangayofficial.php" class="active">Barangay Officials</a></li>
        ...
        <main class="admin-main">
            ...
            <div class="admin-content">
                <div class="content-header d-flex justify-content-between align-items-center" style="margin-bottom: 1.5rem;">
                    <div>
                        <h2 style="margin: 0; font-size: 1.25rem;">Barangay Officials Roster</h2>
                        <p style="margin: 0; color: #6B7280; font-size: 0.85rem;">Add, edit, or remove barangay officials from the public roster.</p>
                    </div>
